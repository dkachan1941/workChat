...
//        }
    ...
    private void handleNotification(String message) {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            pushNotification.putExtra("message", String.format(getResources().getString(R.string.notification_message), message));
    ...
    private void showNotificationMessage(Context context, String title, String message, String timeStamp, Intent intent) {
        ...
        notificationUtils.showNotificationMessage(title, String.format(getResources().getString(R.string.notification_message), message), timeStamp, intent);
    }
    ...
    private void showNotificationMessageWithBigImage(Context context, String title, String message, String timeStamp, Intent intent, String imageUrl) {
        notificationUtils = new NotificationUtils(context);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        notificationUtils.showNotificationMessage(title, String.format(getResources().getString(R.string.notification_message), message), timeStamp, intent, imageUrl);
    }
